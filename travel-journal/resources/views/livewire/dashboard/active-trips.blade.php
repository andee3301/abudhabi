<section class="space-y-3">
    <div class="flex flex-wrap items-center justify-between gap-3">
        <div class="space-y-1">
            <p class="text-sm font-semibold text-slate-900 dark:text-slate-100">Active trips</p>
            <p class="text-xs text-slate-500 dark:text-slate-400">Up to three ongoing journeys with quick progress.</p>
        </div>
        <span class="pill-soft">{{ count($trips) }} in play</span>
    </div>
                ...
                <div class="flex gap-4">
                    ...
                    <div class="flex-1 space-y-3">
                        <div class="flex flex-wrap items-start justify-between gap-3">
                            <div class="space-y-1">
                                <p class="text-[11px] uppercase tracking-[0.14em] text-slate-500">In flight</p>
                        ...
                        <div class="grid grid-cols-3 gap-3 text-xs text-slate-600 dark:text-slate-400">
                            ...
                            <div
                                class="rounded-2xl bg-white/70 p-3 ring-1 ring-slate-200 dark:bg-slate-900/60 dark:ring-slate-800">
                                <p class="text-[11px] uppercase tracking-[0.14em] text-slate-500">Progress</p>
                                <p class="font-semibold text-slate-900 dark:text-white">{{ $trip['progress'] }}%</p>
                            </div>
                        </div>
